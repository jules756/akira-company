...
The pre-call brief is generated by **Follow-Up Manager** at booking time (Cold-to-Cash workflow — see [`../follow-up-manager/knowledge/pre-call-brief-template.md`](../follow-up-manager/knowledge/pre-call-brief-template.md)). Your job is to read it, not regenerate.

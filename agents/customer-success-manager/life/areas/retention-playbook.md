...
Recognized patterns where a client becomes eligible for a library skill:
...
- **Reaches 6-month anniversary** → check whether client has room for any library skill they don't yet have.

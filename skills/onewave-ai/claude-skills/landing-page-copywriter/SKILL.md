...
key: onewave-ai/claude-skills/landing-page-copywriter
...
metadata:
  ...
  - kind: github-dir
    commit: null
    path: skills/landing-page-copywriter
    repo: onewave-ai/claude-skills
    trackingRef: main
    url: https://github.com/onewave-ai/claude-skills/tree/main/skills/landing-page-copywriter
---

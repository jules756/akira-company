...
key: anthropics/knowledge-work-plugins/brand-voice-enforcement
...
metadata:
  ...
  - kind: github-dir
    commit: null
    path: skills/brand-voice-enforcement
    repo: anthropics/knowledge-work-plugins
    trackingRef: main
    url: https://github.com/anthropics/knowledge-work-plugins/tree/main/skills/brand-voice-enforcement
---

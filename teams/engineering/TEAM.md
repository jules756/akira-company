...
description: Planning, building, shipping, and delivering productized AI agents (Amis bundles) to per-client isolated environments. Owns the "Agents (The Bots)" lifecycle, the Akira skill library, and the per-client VM fleet.
slug: engineering
